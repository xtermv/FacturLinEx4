...
var
  ...
  begin
    ...
    // Tamaño fijado en puntos reales para que GTK/DPI no lo amplíe de forma
    // distinta según el monitor. Nueve puntos permite mostrar más filas.
    AGrid.Font.Size := 9;
    ...
    // también en 9 pt para impedir que sobrescriban el tamaño del grid.
    for K := 0 to AGrid.Columns.Count - 1 do
    begin
      AGrid.Columns[K].Font.Name := 'Sans';
      AGrid.Columns[K].Font.Size := 9;
...
begin
  ...
  Edit2.Font.Height := -10;
  Edit3.Font.Height := -10;
  Edit4.Font.Height := -10;
  BitBtn3.Caption := 'Aceptar';
  BitBtn4.Caption := 'Aceptar';
  BitBtn3.Font.Height := -10;
  BitBtn4.Font.Height := -10;
  ...
  EstilarEtiqueta(Label4, CTexto, -11, True);
  EstilarEtiqueta(Label5, CTexto, -10);
  EstilarEtiqueta(Label6, CTextoSuave, -10);
  EstilarEtiqueta(Label7, CTexto, -10);
  EstilarEtiqueta(Label8, CTexto, -10);
  EstilarEtiqueta(Label9, CTextoSuave, -10);
  EstilarEtiqueta(Label10, CTexto, -10);
  ...
  EstilarEtiqueta(Label29, CTextoSuave, -10, True);
  EstilarEtiqueta(Label32, CTextoSuave, -10, True);
  EstilarEtiqueta(Label30, CTexto, -12, True);
  EstilarEtiqueta(Label31, CTexto, -12, True);
  EstilarEtiqueta(Label33, CTexto, -12, True);
  EstilarEtiqueta(Label34, CTexto, -12, True);

  LabelTotal.ParentFont := False;
  LabelTotal.Font.Name := 'Sans';
  LabelTotal.Font.Height := -24;
  ...
  Label28.Font.Height := -14;
  Label28.Font.Style := [fsBold];
  Label28.Layout := tlCenter;

  EstilarEtiqueta(Label11, CTextoSuave, -10, True);
  EstilarEtiqueta(Label12, CTextoSuave, -10, True);
  EstilarEtiqueta(Label13, CTextoSuave, -10, True);
  EstilarEtiqueta(Label14, CTextoSuave, -10, True);
  EstilarEtiqueta(Label15, CTextoSuave, -10, True);
  EstilarEtiqueta(Label16, CTextoSuave, -10, True);
  EstilarEtiqueta(Label17, CTextoSuave, -10, True);
  EstilarEtiqueta(Label18, CTextoSuave, -10, True);
  EstilarEtiqueta(Label19, CVerde, -10, True);
  EstilarEtiqueta(Label36, CTextoSuave, -10, True);
...
begin
  ...
  // Es deliberadamente grande para mostrar muchas líneas simultáneamente.
  ListBox3.SetBounds(190, 99, Panel6.ClientWidth - 410, 178);
