...
uses
  ...
  EditBtn, ZDataset, db, uFLXRemoteBackup;
...
begin
  ...
  LFileName := IncludeTrailingPathDelimiter(RutaIni) + 'FacturConf.ini';
...
begin
  if FDisenoFinalAplicado then Exit;
...
begin
  ...
  { Reescritura final y directa de la sección remota sobre el fichero real. }
  GuardarConfiguracionBackupRemotoPersistente;
  //---- Desactivamos botones ---
  BitBtn1.Enabled := False;
  BitBtn2.Enabled := False;
