...
begin
  ...
  //-- controla el cambio de etiquetas SOLO para el PVP
  if StaticText17.Caption<>Edit8.Text then
    begin
...
begin
  ...
  Edit3.Text:=FormatFloat('0.000',dbPedid.FieldByName('PD10').AsFloat);//---- Costo Pedido
  ...
  Edit4.Text:=FormatFloat('0.000',dbPedid.FieldByName('PD11').AsFloat);//---- Margen Pedido
  StaticText13.Caption:=FormatFloat('0.000',dbArti.FieldByName('A26').AsFloat);//----- Margen Articulo
  if Edit4.Text<>StaticText13.Caption then StaticText13.Color:=$00C5C5F7;

  Edit5.Text:=FormatFloat('0.000',dbPedid.FieldByName('PD12').AsFloat);//---- Precio Pedido
