...
procedure TFFabricantes.FormShow(Sender: TObject);
begin
  AplicarEstiloModerno;
...
procedure TFFabricantes.FormResize(Sender: TObject);
begin
  CentrarPanelEdicion;
end;
...
procedure TFFabricantes.AplicarEstiloModerno;
var
  I: Integer;
...
procedure TFFabricantes.CentrarPanelEdicion;
var
...
procedure TFFabricantes.AplicarContrasteSeleccion(AControl: TWinControl);
{$IFDEF LCLGTK2}
var
...
procedure TFFabricantes.AplicarContrasteSeleccionControles(AParent: TWinControl);
var
  I: Integer;
  C: TControl;
begin
...
procedure TFFabricantes.DBGrid1DrawColumnCell(Sender: TObject;
...
function TFFabricantes.QuitarFlechaOrden(const ATexto: String): String;
var
  P: SizeInt;
begin
  Result:=ATexto;
...
procedure TFFabricantes.ActualizarFlechaOrden;
var
  I: Integer;
  Base: String;
begin
...
procedure TFFabricantes.OrdenarGrid(const ACampo: String;
  AAscendente: Boolean);
var
...
procedure TFFabricantes.DBGrid1TitleClick(Column: TColumn);
begin
