...
begin
  ...
  try
    ...
    qry.SQL.Text :=
      ...
      ' created_at, updated_at, last_attempt_at, token, claimed_by, claimed_at, claimed_until, tipo_factura, origen) ' +
      'VALUES (:serie, :numero, :fecha, :hora, :total, "PENDIENTE", 0, :payload, "", ' +
      ' NOW(), NOW(), NULL, NULL, NULL, NULL, NULL, :tipo_factura, :origen)';
