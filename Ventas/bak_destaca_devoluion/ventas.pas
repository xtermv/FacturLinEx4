...
// FacturLinEx Ventas TPV - selector táctil de formas de pago v67 (2026-07-29)
...
var
  ...
  ImporteEditY, EntregaLabelY, EntregaEditY, AltoCampo, CheckTop: Integer;
  C: TControl;
...
begin
  ...
  begin
    ...
    Edit16.SetBounds(40 + BW, EntregaEditY,
      Panel4.ClientWidth - 64 - BW, AltoCampo);
  end;
