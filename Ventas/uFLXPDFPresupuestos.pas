...
type
  ...
  public
    ...
    procedure TextCenter(const XCenter, Y, ASize: Double; const AText: string;
      ABold: Boolean = False);
    procedure AddPageNumbers(const ATextoIzquierda: string);
...
procedure TFLXPDFDocument.AddPageNumbers(const ATextoIzquierda: string);
var
  I, OldIndex: Integer;
...
begin
  ...
  try
    ...
    begin
      ...
      Text(36, 24, 8, ATextoIzquierda, False);
    end;
  finally
    if OldIndex >= 0 then
