...
Begin
  ...
  // Solo comprueba versión/requisitos y avisa. No sustituye ejecutables.
...
begin
  ...
  // la pestaña Utilidades, situado a la derecha del todo.
  B.Parent := TabSheet9;
  B.Top := BitBtn13.Top;
  ...
  B.Hint := 'Configurar actualizador automático y generar version.ini';
  B.ShowHint := True;
  B.Layout := blGlyphTop;
  B.Spacing := 4;
  B.NumGlyphs := 1;
  ...
  // Carga robusta del icono totalizar.png. Si no existe, el botón queda
  // funcional con texto y se añade nota al Hint, sin molestar al arrancar.
  Icono := '';
  Rutas := TStringList.Create;
  try
